...
export const Footer = () => {
  return (
    <footer className={style.footer}>
      <div className={style.container}>
        <div className={style.subContainer}>
          ...
          <p className={style.aboutUs}>
            We take care of providing fun at your reach hand as well as detailed
            information on each video game released. Do not miss yours!
          </p>
        </div>
      ...
      <p className={style.lastComment}>
        Developed By Group 5 - Henry - All rights reserved
      </p>
    </footer>
  );
};
